  ...
  return (
    <>
      ...
      <InfoModal
        ...
        title='Carga Inicial de Datos'
      >
        <div className='space-y-3 text-sm'>
          <p>
            El archivo CSV debe estar ordenado con las siguientes cabeceras:
          </p>
          <p>
            <strong>mesa, orden, apellido, nombre, dni, dir</strong>
          </p>
          <p>Debajo de las cabeceras, los datos de cada votante en una fila.</p>
      ...
      <FileUploadModal
        ...
        title='Subir CSV - Carga Inicial'
        description='Selecciona el archivo CSV con todos los datos de votantes.'
        acceptedTypes='.csv'
      />
    </>
  );
