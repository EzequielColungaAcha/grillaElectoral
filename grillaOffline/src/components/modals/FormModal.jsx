        ...
        return (
          <div key={name} className='space-y-2'>
            ...
            <select
              ...
              className='w-full px-3 py-2 border border-zinc-300 bg-zinc-800 text-zinc-200 rounded-md focus:outline-none focus:ring-2 focus:ring-zinc-100'
              {...props}
            >
        ...
        return (
          <div key={name} className='space-y-2'>
            ...
            <input
              ...
              value={currentValue}
              onChange={(e) => handleInputChange(name, e.target.value)}
              className='w-full px-3 py-2 border bg-zinc-800 border-zinc-300 text-zinc-200 rounded-md focus:outline-none focus:ring-2 focus:ring-zinc-100'
              {...props}
            />
          </div>
        );
